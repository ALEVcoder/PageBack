...
class Category(models.Model):
    ...
    name = models.CharField(max_length=255, verbose_name='Turkum nomi')
...
class Product(models.Model):
    ...
    category = models.ForeignKey(Category, verbose_name='Turkum', on_delete=models.CASCADE)
    title = models.CharField(max_length=255, verbose_name='Ism')
    slug = models.SlugField(unique=True)
    image = models.ImageField(verbose_name='Rasm')
    description = models.TextField(verbose_name='Tavsif', null=True)
...
class Notebook(Product):
    ...
    processor_freq = models.CharField(max_length=255, verbose_name='CPU chastotasi')
    ram = models.CharField(max_length=255, verbose_name='Operativ xotira')
    video = models.CharField(max_length=255, verbose_name='Video karta')
    time_without_charge = models.CharField(max_length=255, verbose_name='Batareya quvvati')
...
class Smartphone(Product):
    ...
    ram = models.CharField(max_length=255, verbose_name='Operativ xotira')
    sd = models.BooleanField(default=True, verbose_name='SD-kartaning mavjudligi')
    sd_volume_max = models.CharField(
        max_length=255, null=True, blank=True, verbose_name='Maksimal o`rnatilgan xotira'
    )
    main_cam_mp = models.CharField(max_length=255, verbose_name='Asosiy kamera')
    frontal_cam_mp = models.CharField(max_length=255, verbose_name='Old kamera (MP)')
...
class Customer(models.Model):
    ...
    orders = models.ManyToManyField('Order', verbose_name='Xaridorlarning buyurtmalari', related_name='related_order')
...
class Order(models.Model):
    ...
    STATUS_CHOICES = (
        ...
        (STATUS_IN_PROGRESS, 'Qayta ishlashda buyurtma'),
        (STATUS_READY, 'Buyurtma tayyor'),
        (STATUS_COMPLETED, 'Buyurtma tugadi')
    )
    ...
    last_name = models.CharField(max_length=255, verbose_name='Familyangiz')
    phone = models.CharField(max_length=20, verbose_name='Telefon')
    cart = models.ForeignKey(Cart, verbose_name='Корзина', on_delete=models.CASCADE, null=True, blank=True)
    address = models.CharField(max_length=1024, verbose_name='Manzilingiz', null=True, blank=True)
    ...
    comment = models.TextField(verbose_name='Buyurtmani sharhlang', null=True, blank=True)
    created_at = models.DateTimeField(auto_now=True, verbose_name='Buyurtmani yaratish sanasi')
    order_date = models.DateField(verbose_name='Buyurtmani olgan sana', default=timezone.now)
